...
\begin{frame}{L'effet des glaciers sur le paysage Alpin}
  \begin{center}
    \begin{figure}
      ...
      \caption{Les ères glaciaires successives ont grandement participées au façonnage de nos paysages.}
...
\begin{frame}{Simulation numérique}
  \begin{center}
    \begin{figure}
      \subfigure[Simulation après 3100 pas de simulation]{\includegraphics[width=10cm]{Images/3100_cell.png}}
      \subfigure[Simulation après 7100 pas de simulation]{\includegraphics[width=10cm]{Images/7100_cell.png}}
...
\begin{frame}{Front de cellules}
  ...
  Interaction avec les cellules du front actuelle et du front suivant.
  \begin{figure}
    \begin{tabular}{|M|M|M|}
      \arrayrulecolor{sky}
      \hline
