...
\begin{frame}
  \begin{center}
    \begin{figure}
      ...
      \caption{À gauche les Andes, à droite le Japon}
    \end{figure}
  \end{center}
\end{frame}
...
=======
  Sources :\\
  Serge Fudral, Richard Bézin, Benoît Crespin, Xavier Skapin, Olivier Terraz, Philippe Meseure. Opérations
topologiques pour la géomorphologie. Journées de l’Association Française d’Informatique
Graphique, Oct 2011, Biarritz, France. pp.95-104, 2011. <hal-00633705>
  
>>>>>>> 33702f82ce778100c61a4cf5add83b967245ece0
\end{frame}
