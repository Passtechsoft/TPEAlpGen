...
\begin{frame}
 \begin{center}
  \begin{figure}
    \includegraphics[width=4cm]{Images/Diapos/Erosion/Fluviale/bad_lands.jpg}
    \caption{Les « Badlands »}
  \end{figure}
  \begin{figure}
    \includegraphics[width=4cm]{Images/Diapos/Erosion/Fluviale/n_base.jpg}
    \caption{Schéma de l'érosion verticale}
  \end{figure}
 \end{center}
\end{frame}
