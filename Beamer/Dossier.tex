...
Il y a beaucoup de moyens de simuler certains comportements dynamiques en géologiques.
Beaucoup font appel à l'expérience physique, et quelques uns, plus ou moins récents (nous avons déterrés des thèses remontant jusqu'aux années 90) font usage exclusif du numérique.
Bien que pour les besoins de notre simulation et pour rester cohérents avec notre objectif de montrer dynamiquement un système géomorphologique nous avons choisis cette seconde voie.
Il est important de faire justice aux autre expériences, tant numériques que physiques qui nous ont inspirées dans la réalisation de notre simulation.
