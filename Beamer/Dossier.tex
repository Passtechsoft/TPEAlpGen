...
\begin{center}
  \boxed{\displaystyle{Re = \frac{pVL}{\mu}}}
\end{center}
...
\end{center}
\captionof{figure}{À gauche~: Photo de simulation physique par couches de pâtes. À droite~: Photo de simulation par pâtes des indes.}
